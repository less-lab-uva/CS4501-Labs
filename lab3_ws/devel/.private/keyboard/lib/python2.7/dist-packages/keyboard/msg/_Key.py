...
"""autogenerated by genpy from keyboard/Key.msg. Do not edit."""
import codecs
import sys
...
class Key(genpy.Message):
  _md5sum = "5d57616b5631968b8f1d31d23c83281f"
  _type = "keyboard/Key"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """uint16 KEY_UNKNOWN=0
uint16 KEY_FIRST=0
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2H().pack(_x.code, _x.modifiers))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.code, _x.modifiers,) = _get_struct_2H().unpack(str[start:end])
      return self
